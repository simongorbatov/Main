...
Facts every chief needs. The CEO keeps this current; update it the moment something changes.
...
`[School]`, `[Store]`, `[Health]`, `[Life]`. Every event a chief proposes carries one.

## How Simon wants answers

- The list, not a briefing. Lead with what has to be done.
